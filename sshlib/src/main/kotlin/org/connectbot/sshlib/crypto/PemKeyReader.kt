...
internal object PemKeyReader {
    ...
    private val SECP256R1_OID = byteArrayOf(0x2a, 0x86.toByte(), 0x48, 0xce.toByte(), 0x3d, 0x03, 0x01, 0x07)
    private val SECP384R1_OID = byteArrayOf(0x2b, 0x81.toByte(), 0x04, 0x00, 0x22)
    private val SECP521R1_OID = byteArrayOf(0x2b, 0x81.toByte(), 0x04, 0x00, 0x23)
}
