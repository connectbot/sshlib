...
/**
 * PEM Encoder for exporting SSH keys in OpenSSH format.
 * <p>
 * This class provides methods to export RSA, DSA, EC, and Ed25519 key pairs
 * in the OpenSSH private key format, with optional passphrase-based encryption
 * using AES-256-CTR and bcrypt_pbkdf.
 * <p>
 * This is the encoding counterpart to {@link PEMDecoder}.
 *
 * @author Kenny Root
 */
